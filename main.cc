...
int main(int argc, char *argv[])
{
	...
	try
	{
   	...
   	readingTime = elapsed_time();
		...
		std::cout << "Final reading time: " << readingTime << 's' << '\n';
		std::cout << "Final computation time: " << computationTime << 's' << '\n';
		std::cout << "Final writing time: " << writingTime << 's' << '\n';
		std::cout << "Final total time: " << totalTime << 's' << '\n';
