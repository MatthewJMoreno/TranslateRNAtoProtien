...
void MPI_Parallelization(Parameters parameters, char* fileName, int id, int p, int fileWidth, long long fileSize){
	...
	if (id == 0){
		...
		std::cout << "Average reading time: " << globalReadinTime / p << " seconds" << std::endl;
		std::cout << "Average computation time: " << globalComputationTime / p << " seconds" << std::endl;
		std::cout << "Average writing time: " << globalWriteInTime / p << " seconds" << std::endl;
		std::cout << "Average total time: " << totalTime / p << " seconds" << std::endl;
	}
}
